...
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
//  광고 설정 — 여기 URL만 바꾸면 광고 교체됩니다
// ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
const AD_CONFIG = {
  // 스플래시(시작화면) 광고 페이지 URL — AdSense 붙인 내 사이트 주소
  splashAdUrl: 'https://YOUR-SITE.com/ad-splash',
  // 메인 하단 배너 광고 URL
  bannerAdUrl: 'https://YOUR-SITE.com/ad-banner',
  // 스플래시 표시 시간 (ms) — 광고 노출 시간
  splashDuration: 4000,
};
...
ipcMain.handle('apply-system-cursor', async (_, { pngBase64, hotX, hotY }) => {
  if (process.platform !== 'win32') return { ok: false, msg: 'Windows 전용 기능입니다.' };
  try {
    ...
    if (!fs.existsSync(curPath)) return { ok: false, msg: '.cur 파일 생성 실패' };
